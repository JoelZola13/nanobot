...
export function GenerationForm() {
  ...
  const captureStatusText = isTranscribing
    ...
    : isRecording
      ? 'Recording... click "Stop capture and generate" to transcribe and generate.'
      : '';
      ...
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            {captureStatusText ? (
              <p className="text-xs text-muted-foreground">{captureStatusText}</p>
            ) : null}
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={isPending || isTranscribing || !selectedProfileId}
              >
                {isRecording ? (
                  <>
              ...
              <Button
                type="submit"
                className="flex-1"
                disabled={isPending || isRecording || isTranscribing || !selectedProfileId}
              >
                {isPending ? (
                  <>
                    <Loader2 className="mr-2 h-4 w-4 animate-spin" />
