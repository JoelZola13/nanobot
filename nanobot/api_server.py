...
from nanobot.gallery_api import (
    ...
    gallery_update_artwork as _gallery_update_artwork,
    ...
    street_profile_serve_portfolio_image as _street_profile_serve_portfolio_image,
    street_profile_save_portfolio as _street_profile_save_portfolio,
    street_profile_upload_banner as _street_profile_upload_banner,
    street_profile_serve_banner as _street_profile_serve_banner,
...
app = Starlette(
    routes=[
        ...
        # ── Gallery (legacy local-JSON upload endpoint; full API is below) ──
        ...
        Route("/gallery/artworks/{artwork_id:path}", _gallery_update_artwork, methods=["PATCH"]),
        Route("/gallery/artworks/{artwork_id:path}", _gallery_delete_artwork, methods=["DELETE"]),
        ...
        Route("/uploads/gallery/{filename:path}", _gallery_serve_upload, methods=["GET"]),
        Route("/street-profiles/batch-lookup", _street_profiles_batch_lookup, methods=["POST"]),
        Route("/street-profiles/avatar", _street_profile_upload_avatar, methods=["POST"]),
        Route("/street-profiles/portfolio-image", _street_profile_upload_portfolio_image, methods=["POST"]),
        Route("/street-profiles/portfolio", _street_profile_save_portfolio, methods=["PUT"]),
        Route("/street-profiles/banner", _street_profile_upload_banner, methods=["POST"]),
